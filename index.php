            ...
            <div>
              <form role="form" class="form_login_custom">
                ...
                <div class="input-group mb-2 input-group-lg">
                  ...
                  <input type="email" class="form-control form-control_custom form-control_custom2" placeholder="E-mail" id="emailLogin" />
                </div>
                ...
                <div class="input-group mb-4 input-group-lg">
                  ...
                  <input type="password" class="form-control form-control_custom form-control_custom2" placeholder="Senha" id="senhaLogin" />
                </div>

                <button type="submit" class="btn btn_login btn-block btn-lg" id="btn_login">
                  Log In
                </button>
  ...
  $(document).ready(function() {
    ...
    $("#btn_login").click(function(e) {
      ...
      $.ajax({
        ...
        dataType: 'JSON', //tipo de retorno dos dados esperado
        url: 'actions/login.php', //Arquivo php
        data: {                 //Dados
        ...
        }//fim do sucess: function data

      }); //fim $.ajax 

    }); // fim btn login

  }); //fim documento.ready function
